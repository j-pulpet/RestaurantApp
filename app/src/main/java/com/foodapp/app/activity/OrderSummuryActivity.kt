...
//    var postal_code=""
    ...
    override fun InitView() {
        ...
        if(getStringPref(this@OrderSummuryActivity, SharePreference.SELECTED_LANGUAGE).equals(resources.getString(R.string.language_hindi))){
            ivBack.rotation= 180F
        }else{
            ivBack.rotation= 0F
        }
/*
//        edAddress.text="New York, NY, USA"
        edPinCode.text="10001"
        edBuilding.text="10"
        edLandmark.text="New York"*/
