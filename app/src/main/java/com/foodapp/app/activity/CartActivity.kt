...
class CartActivity : BaseActivity() {
    ...
    override fun InitView() {
        ...
        if(getStringPref(this@CartActivity, SharePreference.SELECTED_LANGUAGE).equals(resources.getString(R.string.language_hindi))){
              ...
              position: Int
                ...
                holder.itemView.ivPlus.setOnClickListener {
                    if(cartItem!!.get(position).getQty()!!.toInt()<getStringPref(this@CartActivity,SharePreference.isMiniMumQty)!!.toInt()){
                      ...
                      alertErrorOrValidationDialog(this@CartActivity,"Maximum quantity allowed is ${getStringPref(this@CartActivity,SharePreference.isMiniMumQty)} for this item.")
                    }
                }
            }
