...
//        val referprice=getStringPref(this@RefarAndEarnActivity, SharePreference.isCurrancy)+String.format(Locale.US,"%,.2f",price)
        ...
        if(SharePreference.getStringPref(this@RefarAndEarnActivity, SharePreference.SELECTED_LANGUAGE)
